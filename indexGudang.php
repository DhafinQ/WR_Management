...
$gudangs = $controller->getGudangData($conn);
?>
<html lang="en">
...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="indexGudang.php" class="flex items-center active-nav-link text-white  py-4 pl-6 nav-item">
    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <h1 class="text-3xl text-black pb-6">Gudang</h1>
                ...
                <div class="w-full mt-12">
                    <div class="flex justify-between">
                        <p class="text-xl pb-3 flex items-center">
                            <i class="fas fa-list mr-3"></i> Tabel Gudang
                        </p>

                        <a href="formTambahGudang.php" class="bg-sidebar hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4"><i class="fa fa-plus mr-2"></i> Tambah</a>


                    </div>
                    <div class="bg-white overflow-auto p-5">
                        <table class="display w-full" id="table-gudang">
                            <thead>
                                <tr>
                                    <th>Nama Gudang</th>
                                    <th>alamat</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?= htmlspecialchars($gudang['kapasitas']) ?> kg</td>
                                            <td>
                                                <a href="#" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded show-button" data-id="<?= $gudang['id_gudang'] ?>"><i class="fa fa-eye"></i></a>
                                                <a href="formEditGudang.php?id=<?= $gudang['id_gudang'] ?>" class="bg-yellow-500 hover:bg-blue-700 text-white font-bo py-2 px-4 rounded"><i class="fa fa-pen"></i></a>
                                                <a href="logic/hapus.php?m=gudang&id=<?= $gudang['id_gudang'] ?>" class="bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded delete-btn" data-id="<?= $gudang['id_gudang'] ?>"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                <?php endforeach;
                                endif; ?>
                    ...
                    <div class="flex items-center justify-center min-h-screen p-4 text-center">
                        <div class="relative bg-white rounded-lg shadow-xl w-full max-w-md">
                            ...
                            <div class="flex justify-between items-center p-4 border-b">
                                <h3 class="text-lg font-semibold text-gray-900">Detail Gudang</h3>
                            ...
                            <div class="p-4">
                                <form id="editForm">
                                    <div class="mb-4">
                                        <label for="nama_gudang" class="block text-left text-sm font-medium text-gray-700">Nama gudang</label>
                                        <input type="text" id="nama_gudang" name="nama_gudang" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" readonly>
                                    </div>
                                    <div class="mb-4">
                                        <label for="alamat" class="block text-left text-sm font-medium text-gray-700">alamat</label>
                                        <input type="text" id="alamat" name="alamat" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" readonly>
                                    </div>
                                    <div class="mb-4">
                                        <label for="kapasitas" class="block text-left text-sm font-medium text-gray-700">kapasitas (Kg)</label>
                                        <input type="text" id="kapasitas" name="kapasitas" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" readonly>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#table-gudang').on('click', '.show-button', function(e) {
                e.preventDefault();
                let gudangID = $(this).data('id'); // Get the ID from the button's data attribute
                ...
                $.ajax({
                    url: `logic/tampil.php?model=gudang&id=${gudangID}`, // Update the URL to your PHP script
                    method: 'GET',

...
$gudang = $controllers->getGudang($conn,$_GET['id']);
            ...
            <main class="w-full flex-grow p-6">
                ...
                <nav aria-label="breadcrumb" class="w-max">
                    <ol class="flex w-full flex-wrap items-center rounded-md bg-slate-50 px-4 py-2">
                        ...
                        <li class="flex cursor-pointer items-center text-sm text-slate-500 transition-colors duration-300 hover:text-slate-800">
                            <a href="indexGudang.php">Gudang</a>
                            <span class="pointer-events-none mx-2 text-slate-800">
                                /
                            </span>
                        </li>
                        <li class="flex cursor-pointer items-center text-sm text-slate-500 transition-colors duration-300 hover:text-slate-800">
                            <a href="javascript:void()">Edit Gudang</a>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="w-full mt-12">
                    <p class="text-xl pb-6 flex items-center">
                        <i class="fas fa-list mr-3"></i> Form Edit Gudang
                    </p>
                    <div class="leading-loose">
                        <form class="p-10 bg-white rounded shadow-xl" id="gudangForm">
                            <input type="hidden" name="model" value="gudang">
                            <input type="hidden" name="id_gudang" value="<?= $gudang['id_gudang']?>">
                            <div class="">
                                <label class="block text-sm text-gray-600" for="nama_gudang">Nama gudang</label>
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" value="<?= $gudang['nama_gudang']?>" id="nama_gudang" name="nama_gudang" type="text" required="" placeholder="Masukan Nama Barang..." aria-label="Name">
                            </div>
                            <div class="">
                                <label class="block text-sm text-gray-600" for="alamat">alamat</label>
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" value="<?= $gudang['alamat']?>" id="alamat" name="alamat" type="text" required="" placeholder="Masukan alamat gudang..." aria-label="Name">
                            </div>
                            <div class="">
                                <label class="block text-sm text-gray-600" for="kapasitas">kapasitas</label>
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" value="<?= $gudang['kapasitas']?>" id="kapasitas" name="kapasitas" type="number" required="" aria-label="kapasitas">
                            </div>
                ...
                success: function(response) {
                    if (response == 'success') {
                        Swal.fire({
                            ...
                            window.location = 'indexGudang.php'; // Redirect to index after alert
                        });
                    } else {
                        Swal.fire({
                            icon: 'error',

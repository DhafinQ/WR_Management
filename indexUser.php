...
$users = $controller->getUserData($conn);
?>
<html lang="en">
...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="indexPemasok.php" class="flex items-center opacity-75 hover:opacity-100 text-white  py-4 pl-6 nav-item">
            ...
            <a href="indexUser.php" class="flex items-center active-nav-link text-white  py-4 pl-6 nav-item">
            ...
            <main class="w-full flex-grow p-6">
                ...
                <div class="w-full mt-12">
                    <div class="flex justify-between">
                        <p class="text-xl pb-3 flex items-center">
                            <i class="fas fa-list mr-3"></i> Tabel User
                        </p>

                        <a href="formTambahUser.php" class="bg-sidebar hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4"><i class="fa fa-plus mr-2"></i> Tambah</a>


                    </div>
                    <div class="bg-white overflow-auto p-5">
                        <table class="display w-full" id="table-user">
                            <thead>
                                <tr>
                                    <th>Nama User</th>
                                    <th>Email</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded show-button" data-id="<?= $user['id'] ?>"><i class="fa fa-eye"></i></a>
                                                <a href="formEditUser.php?id=<?= $user['id'] ?>" class="bg-yellow-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"><i class="fa fa-pen"></i></a>
                                                <a href="logic/hapus.php?m=user&id=<?= $user['id'] ?>" class="bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded delete-btn" data-id="<?= $user['id'] ?>"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                <?php endforeach;
                                endif; ?>
                    ...
                    <div class="flex items-center justify-center min-h-screen p-4 text-center">
                        <div class="relative bg-white rounded-lg shadow-xl w-full max-w-md">
                            ...
                            <div class="p-4">
                                <form id="editForm">
                                    <div class="mb-4">
                                        <label for="nama_lengkap" class="block text-left text-sm font-medium text-gray-700">Nama Lengkap</label>
                                        <input type="text" id="nama_lengkap" name="nama_lengkap" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" readonly>
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" id="role" name="role" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" readonly>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#table-user').on('click', '.show-button', function(e) {
                e.preventDefault();
                let userID = $(this).data('id'); // Get the ID from the button's data attribute
                ...
                $.ajax({
                    url: `logic/tampil.php?model=user&id=${userID}`, // Update the URL to your PHP script
                    method: 'GET',

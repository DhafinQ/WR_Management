            ...
            <main class="w-full flex-grow p-6">
                ...
                <nav aria-label="breadcrumb" class="w-max">
                    <ol class="flex w-full flex-wrap items-center rounded-md bg-slate-50 px-4 py-2">
                        ...
                        <li class="flex cursor-pointer items-center text-sm text-slate-500 transition-colors duration-300 hover:text-slate-800">
                            <a href="javascript:void()">Tambah Barang</a>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="w-full mt-12">
                    <p class="text-xl pb-6 flex items-center">
                        <i class="fas fa-list mr-3"></i> Form Tambah Barang
                    </p>
                    <div class="leading-loose">
                        <form class="p-10 bg-white rounded shadow-xl" id="barangForm">
                            ...
                            <div class="">
                                ...
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="nama_barang" name="nama_barang" type="text" required="" placeholder="Masukan Nama Barang..." aria-label="Name">
                            </div>
                            <div class="">
                                <label class="block text-sm text-gray-600" for="kategori">Kategori</label>
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="kategori" name="kategori" type="text" required="" placeholder="Masukan Kategori Barang..." aria-label="Name">
                            </div>
                            <div class="">
                                <label class="block text-sm text-gray-600" for="harga">Harga</label>
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="harga" name="harga" type="number" required="" aria-label="harga">
                            </div>
                            <div class="">
                                <label class="block text-sm text-gray-600" for="jumlah_stok">Stok Barang</label>
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="jumlah_stok" name="jumlah_stok" type="number" required="" aria-label="harga">
                            </div>
                            <div class="">
                                <label class="block text-sm text-gray-600" for="tgl_kadaluwarsa">Tanggal Kadaluwarsa</label>
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="tgl_kadaluwarsa" name="tgl_kadaluwarsa" type="date" aria-label="harga">
                            </div>
                            <div class="">
                            ...
                            <div class="mt-2">
                                ...
                                <textarea class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded" id="deskripsi" name="deskripsi" rows="6" required="" placeholder="Masukan Deskripsi Barang..." aria-label="Email"></textarea>
                            </div>
                            <div class="mt-6">

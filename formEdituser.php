...
$user = $controllers->getUser($conn,$_GET['id']);
            ...
            <main class="w-full flex-grow p-6">
                ...
                <nav aria-label="breadcrumb" class="w-max">
                    <ol class="flex w-full flex-wrap items-center rounded-md bg-slate-50 px-4 py-2">
                        ...
                        <li class="flex cursor-pointer items-center text-sm text-slate-500 transition-colors duration-300 hover:text-slate-800">
                            <a href="indexUser.php">User</a>
                            <span class="pointer-events-none mx-2 text-slate-800">
                                /
                            </span>
                        </li>
                        <li class="flex cursor-pointer items-center text-sm text-slate-500 transition-colors duration-300 hover:text-slate-800">
                            <a href="javascript:void()">Edit User</a>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="w-full mt-12">
                    <p class="text-xl pb-6 flex items-center">
                        <i class="fas fa-list mr-3"></i> Form Edit User
                    </p>
                    <div class="leading-loose">
                        <form class="p-10 bg-white rounded shadow-xl" id="userForm">
                            <input type="hidden" name="model" value="user">
                            <input type="hidden" name="id" value="<?= $user['id']?>">
                            <div class="">
                                <label class="block text-sm text-gray-600" for="nama_lengkap">Nama User</label>
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" value="<?= $user['nama_lengkap']?>" id="nama_lengkap" name="nama_lengkap" type="text" required="" placeholder="Masukan Nama Lengkap..." aria-label="Name">
                            </div>
                            <div class="">
                                <label class="block text-sm text-gray-600" for="email">Email Pemasok</label>
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" value="<?= $user['email']?>" id="email" name="email" type="email" required="" placeholder="Masukan email pemasok..." aria-label="Name">
                                </div>
                                <div class="">
                                <label class="block text-sm text-gray-600" for="password">Password</label>
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="password" name="password" type="password"aria-label="Name">
                            </div>
                            <div class="">
                            <label class="block text-sm text-gray-600" for="jumlah">Role</label>
                                <select
                                    name="role"
                ...
                success: function(response) {
                    if (response.trim() === 'success') {
                        Swal.fire({
                            ...
                            window.location = 'indexUser.php'; // Redirect to index after alert
                        });
                    } else {
                        Swal.fire({
                            icon: 'error',

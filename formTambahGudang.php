...
<head>
    ...
    <title>Form Tambah Gudang</title>
            ...
            <main class="w-full flex-grow p-6">
                ...
                <nav aria-label="breadcrumb" class="w-max">
                    <ol class="flex w-full flex-wrap items-center rounded-md bg-slate-50 px-4 py-2">
                        ...
                        <li class="flex cursor-pointer items-center text-sm text-slate-500 transition-colors duration-300 hover:text-slate-800">
                            <a href="javascript:void()">Tambah Gudang</a>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="w-full mt-12">
                    <p class="text-xl pb-6 flex items-center">
                        <i class="fas fa-list mr-3"></i> Form Tambah Gudang
                    </p>
                    <div class="leading-loose">
                        <form class="p-10 bg-white rounded shadow-xl" id="gudangForm">
                            ...
                            <div class="">
                                ...
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="nama_gudang" name="nama_gudang" type="text" required="" placeholder="Masukan Nama Gudang..." aria-label="Name">
                            </div>
                            <div class="">
                                <label class="block text-sm text-gray-600" for="alamat">alamat</label>
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="alamat" name="alamat" type="text" required="" placeholder="Masukan Alamat Gudang..." aria-label="Name">
                            </div>
                            <div class="">
                                <label class="block text-sm text-gray-600" for="kapasitas">kapasitas</label>
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="kapasitas" name="kapasitas" type="number" required="" aria-label="kapasitas">
                            </div>

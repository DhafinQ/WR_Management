...
$barangs = $controller->getBarangData($conn);
?>
<html lang="en">
...
<body class="bg-gray-100 font-family-karla flex">
            ...
            <main class="w-full flex-grow p-6">
                ...
                <div class="w-full mt-12">
                    <div class="flex justify-between">
                        ...
                        <a href="formTambahBarang.php" class="bg-sidebar hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4"><i class="fa fa-plus mr-2"></i> Tambah</a>


                    </div>
                    <div class="bg-white overflow-auto p-5">
                        <table class="display w-full" id="table-barang">
                            <thead>
                                <tr>
                                    <th>Nama Barang</th>
                                    <th>Kategori</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?= "Rp " . number_format(htmlspecialchars($barang['harga']), 2, ",", ".") ?></td>
                                            <td><?= htmlspecialchars($barang['jumlah_stok']) ?></td>
                                            <td><?= $controller->getNamaGudang($conn, $barang['id'], $barang['lokasi_gudang']); ?></td>
                                            <td>
                                                <a href="#" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded show-button" data-id="<?= $barang['id'] ?>"><i class="fa fa-eye"></i></a>
                                                <a href="formEditBarang.php?id=<?= $barang['id'] ?>" class="bg-yellow-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"><i class="fa fa-pen"></i></a>
                                                <a href="logic/hapus.php?m=barang&id=<?= $barang['id'] ?>" class="bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded delete-btn" data-id="<?= $barang['id'] ?>"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                <?php endforeach;
                                endif; ?>
                        ...
                        <div class="relative bg-white rounded-lg shadow-xl w-full max-w-md">
                            ...
                            <div class="p-4">
                                <form id="editForm">
                                    ...
                                    <div class="mb-4">
                                        <label for="kategori" class="block text-left text-sm font-medium text-gray-700">Kategori</label>
                                        <input type="text" id="kategori" name="kategori" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" readonly>
                                    </div>
                                    <div class="mb-4">
                                        <label for="harga" class="block text-left text-sm font-medium text-gray-700">Harga (Pcs)</label>
                                        <input type="text" id="harga" name="harga" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" readonly>
                                    </div>
                                    <div class="mb-4">
                                        <label for="jumlah_stok" class="block text-left text-sm font-medium text-gray-700">Jumlah Stok</label>
                                        <input type="text" id="jumlah_stok" name="jumlah_stok" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" readonly>
                                    </div>
                                    <div class="mb-4">
                                        <label for="nama_gudang" class="block text-left text-sm font-medium text-gray-700">Lokasi Gudang</label>
                                        <input type="text" id="nama_gudang" name="nama_gudang" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" readonly>
                                    </div>
                                    <div class="mb-4">
                                        <label for="nama_pemasok" class="block text-left text-sm font-medium text-gray-700">Pemasok</label>
                                        <input type="text" id="nama_pemasok" name="nama_pemasok" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" readonly>
                                    </div>
                                    <div class="mb-4">
                                        <label for="tgl_kadaluwarsa" class="block text-left text-sm font-medium text-gray-700">Tanggal Kadaluwarsa</label>
                                        <input type="text" id="tgl_kadaluwarsa" name="tgl_kadaluwarsa" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" readonly>
                                    </div>
                                    <div class="mb-4">
                                        <label for="deskripsi" class="block text-left text-sm font-medium text-gray-700">Deskripsi</label>
                                        <textarea id="deskripsi" class="w-full px-5 py-2 rounded" readonly></textarea>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#table-barang').on('click', '.show-button', function(e) {
                e.preventDefault();
                let barangId = $(this).data('id'); // Get the ID from the button's data attribute
                ...
                $.ajax({
                    url: `logic/tampil.php?model=barang&id=${barangId}`, // Update the URL to your PHP script
                    method: 'GET',
                    success: function(response) {
                        ...
                        let formattedHarga = formatRupiah(data.harga);
                        ...
                        $('#tgl_kadaluwarsa').val(data.tgl_kadaluwarsa);

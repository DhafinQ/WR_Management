...
$pemasoks = $controller->getPemasokData($conn);
?>
<html lang="en">
...
<body class="bg-gray-100 font-family-karla flex">
            ...
            <main class="w-full flex-grow p-6">
                ...
                <div class="w-full mt-12">
                    <div class="flex justify-between">
                        <p class="text-xl pb-3 flex items-center">
                            <i class="fas fa-list mr-3"></i> Tabel Pemasok
                        </p>

                        <a href="formTambahPemasok.php" class="bg-sidebar hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4"><i class="fa fa-plus mr-2"></i> Tambah</a>


                    </div>
                    <div class="bg-white overflow-auto p-5">
                        <table class="display w-full" id="table-pemasok">
                            <thead>
                                <tr>
                                    <th>Nama Pemasok</th>
                                    <th>Email</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded show-button" data-id="<?= $pemasok['id'] ?>"><i class="fa fa-eye"></i></a>
                                                <a href="formEditPemasok.php?id=<?= $pemasok['id'] ?>" class="bg-yellow-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"><i class="fa fa-pen"></i></a>
                                                <a href="logic/hapus.php?m=pemasok&id=<?= $pemasok['id'] ?>" class="bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded delete-btn" data-id="<?= $pemasok['id'] ?>"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                <?php endforeach;
                                endif; ?>
                    ...
                    <div class="flex items-center justify-center min-h-screen p-4 text-center">
                        <div class="relative bg-white rounded-lg shadow-xl w-full max-w-md">
                            ...
                            <div class="flex justify-between items-center p-4 border-b">
                                <h3 class="text-lg font-semibold text-gray-900">Detail Pemasok</h3>
                            ...
                            <div class="p-4">
                                <form id="editForm">
                                    <div class="mb-4">
                                        <label for="nama_pemasok" class="block text-left text-sm font-medium text-gray-700">Nama Pemasok</label>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" id="email" name="email" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" readonly>
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        <label for="no_tlp" class="block text-left text-sm font-medium text-gray-700">No.Telepon</label>
                                        <input type="text" id="no_tlp" name="no_tlp" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" readonly>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#table-pemasok').on('click', '.show-button', function(e) {
                e.preventDefault();
                let pemasokID = $(this).data('id'); // Get the ID from the button's data attribute
                ...
                $.ajax({
                    url: `logic/tampil.php?model=pemasok&id=${pemasokID}`, // Update the URL to your PHP script
                    method: 'GET',

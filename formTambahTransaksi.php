        ...
        <header class="w-full items-center bg-white py-2 px-6 hidden sm:flex">
            ...
            <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                <button @click="isOpen = !isOpen" class="realtive z-10 w-12 h-12 rounded-full overflow-hidden border-2 border-gray-400 hover:border-gray-300 focus:border-gray-300 focus:outline-none">
                    <svg height="44px" width="44px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60.671 60.671" xml:space="preserve" fill="#ddddd">
            ...
            <main class="w-full flex-grow p-6">
                ...
                <nav aria-label="breadcrumb" class="w-max">
                    <ol class="flex w-full flex-wrap items-center rounded-md bg-slate-50 px-4 py-2">
                        ...
                        <li class="flex cursor-pointer items-center text-sm text-slate-500 transition-colors duration-300 hover:text-slate-800">
                            <a href="javascript:void()">Tambah Transaksi</a>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="w-full mt-12">
                    <p class="text-xl pb-6 flex items-center">
                        <i class="fas fa-list mr-3"></i> Form Tambah Transaksi
                    </p>
                    <div class="leading-loose">
                        <form class="p-10 bg-white rounded shadow-xl" id="transaksiForm">
                            <input type="hidden" name="model" value="transaksi">
                            <div class="">
                                <label class="block text-sm text-gray-600" for="barang">Barang</label>
                                <select
                                    name="id_barang"
                            ...
                            <div class="">
                                ...
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="jumlah" name="jumlah" type="number" required="" placeholder="Masukan Email Pemasok..." aria-label="Name">
                            </div>
                            <div class="">
                            ...
                            <div class="">
                                ...
                                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="tgl_transaksi" name="tgl_transaksi" type="date" aria-label="harga">
                            </div>
